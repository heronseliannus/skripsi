...
<form action="" class="registrasi">
            ...
            <fieldset class="baris1">
                <legend>Input Registrasi Peserta Pelatihan</legend>
                ...
                <p>
                    ...
                    <label class="gender">Pria</label>
                    <input type="radio" value="radio"/>
                    <label class="gender">Wanita</label>
                    <input type="radio" value="radio"/>
                </p>
                <p>
                    <label>Tanggal_Lahir *
                ...
                <div class="kotakinfo"><h4>Informasi</h4>
                    <p>Beri Tanda Ceklis pada text pelatihan adalah penjelasan penting lainnya tentang Anda.</p>
                </div>
            </fieldset>
         
                <p class="perjanjian">
                    <input type="checkbox" value=""/>
                    <label>*  Saya menyetujui <a href="#">Syarat dan Ketentuan</a></label>
                </p>
                <p class="perjanjian">
                    <input type="checkbox" value=""/>
                    <label>Saya memberikan hak atas data diri Anda untuk situs Anda</label>
                </p>
                <p class="perjanjian">
                    <input type="checkbox" value=""/>
                    <label>Semua data yang telah disi sesuai dengan data dan ketentuan yang berlaku</label>
                </p>


            <div><tombol class="tombol"> registrasi &raquo; </tombol></div>
        </form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <p>Silahkan ikuti akun media sosial kita untuk mendapatkan info lebih lanjud</p>
                    </div>
                </div>
            </div>
        </div>
